  ...
  function ScrollSmoother(e) {
    ...
    function Fa(r, e, t, n) {
      function tb() {
        (e = s()),
          ...
          (c = (a = "auto" === e) ? 0 : 0.5),
          l && l.kill(),
          (l = t && B.to(r, { ease: O, overwrite: !1, y: "+=0", duration: t })),
    ...
    L.addEventListener("refresh", Ba),
      ...
      (this.scrollTo = function (e, t, r) {
        ...
        t
          ? u
            ? B.to(o, { duration: E, scrollTop: n, overwrite: "auto", ease: O })
            : x(n)
          : xa(n);
      }),
      (this.offset = function (e, t) {
        var r,
          ...
          o = L.create({ trigger: e, start: t || "top top" });
        return (
          w && Aa([o]),
          (r = o.start),
          o.kill(!1),
    ...
    A.forEach(function (e) {
      ...
      (this.kill = function () {
        ...
        L.scrollerProxy(m),
          ...
          (n.style.cssText = c);
        var r = L.defaults({});
        r && r.scroller === m && L.defaults({ scroller: F }),
      ...
      T &&
        (this.normalizer = L.normalizeScroll(
          !0 === T ? { debounce: !0, content: n } : T
        )),
      L.config(e),
      "overscrollBehavior" in F.getComputedStyle(I) &&
        B.set([I, M], { overscrollBehavior: "none" }),
      "scrollBehavior" in F.getComputedStyle(I) &&
        B.set([I, M], { scrollBehavior: "auto" }),
